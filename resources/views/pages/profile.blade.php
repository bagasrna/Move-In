        ...
        <div class="flex flex-col justify-center w-full mt-[200px]">
            ...
            <div class="flex flex-row mt-[50px] justify-center">
                    ...
                    <div class="flex flex-col ml-[100px] font-Open Sans">
                        ...
                        <input value="{{ $user->birth_date }}" type="date" name="birth_date" class="w-[600px] placeholder:text-black  border rounded-md mt-5 bg-[#D6E4E5] p-3 placeholder:-pl-[600px]" placeholder="Birth Date dd/mm/yy">

...
<body>
    ...
    <div class="flex flex-row ml-[50px] mt-[200px]">
        <img src="/image/home4.png" class="w-[500px] flex h-[400px]" alt="">
    ...
    <div class="flex justify-end mr-[150px]">
            <a href="/checkout/packin" class="p-3 text-[16px] justify-center flex w-[150px] text-sm font-semibold text-white bg-[#4FA095] rounded-lg">BOOK</a>
    </div>
</body>
</html>
...
<body>
    <div class="flex flex-col cursor-pointer mx-20 mt-[50px]">
        <div class="flex flex-row items-center">
            ...
            <a href="/history" class="text-[26px] font-bold tracking-[5px] ml-5">back</a>
        </div>
        <form action="/book/edit" method="post">
            ...
            <div class="flex flex-row justify-between mt-[50px]">
                <div class="flex flex-col">
                    ...
                    <h1 class="text-[20px] mt-[50px] text-[#035397] font-bold tracking-[10px] justify-center flex ">EDIT</h1>
                    <input type="date" name="date" value="{{ $jasa->date }}" class="border-2 shadow-lg w-[500px] p-10 mt-[20px] rounded-xl">
                </div>
                <div class="flex-col flex">
                    <div class="bg-[#D6E4E5] p-5 flex justify-between w-[400px] rounded-xl mt-[100px]">
                        ...
                        <div>
                            ...
                            <input type="number" id="counter" value="{{ $jasa->quantity }}" name="quantity" class="bg-[#D6E4E5] border-2 w-[50px] mx-[50px] border-black text-center">
                    ...
                    <div class="bg-[#D6E4E5] font-bold p-5 flex justify-between w-[400px] rounded-xl mt-[20px]">
                        ...
                        <div>
                            <span>Rp. </span>
                            <input type="text" name="total" value="{{ $jasa->total }}" id="total" class="bg-[#D6E4E5] placeholder:text-black"></input>
                        </div>
                    </div>
                </div>
            </div>
